...
class AbyssLangPersian(object):
    name = 'هرکی که زودتر رفت'
    description = 'برو پایین که نمیری'
    help = 'مرحله سه بعدی هیجان انگیز'
    author = 'سازنده: JAVAD'
    github = 'گیت هاب: Modestan-Iran'
    blog = 'وبسایت: http://modestaniran.blogfa.com'

    peaceTime = 'زمان صلح'
    npcDensity = 'تراکم NPC'

    hint_use_punch = 'شما می توانید حریفان خود را با مشت بزنید'
...
class AbyssLangEnglish(object):
    ...
    author = 'Author: JAVAD'
    github = 'GitHub: Modestan-Iran'
    blog = 'Blog: http://modestaniran.blogfa.com'
...
if bs.getLanguage() == 'Persian':
    AbyssLang = AbyssLangPersian
